...
def save_filing_html(filing: dict[str, str], output_directory: str | Path) -> Path:
...
def fetch_and_save_all_filings(
    user: str,
    output_directory: str | Path = "data/raw",
):
...
if __name__ == "__main__":
    ...
    fetch_and_save_all_filings(str(user_agent), "../data/raw")
